...
@section("title","Show modelEmployees")
@section("content")
<div>
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="name">Employee Full Name</label>
        <input readonly autofocus='true' value='{{ $item->fname ." " .$item->lname}}' type="text" class="form-control" name="name" id="name" placeholder="Enter modelEmployees Name">
    ...
    <a href='{{ route("modelEmployees.edit",$item->id) }}' class='btn btn-sm btn-info'>Edit</a>
    <a class='btn btn-light' href='{{route("modelEmployees.index")}}'>Cancel</a>
