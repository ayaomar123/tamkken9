...
<form method='post' action='{{asset("modelEmployees")}}'>
    @csrf
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="empNo">Department Id</label>
            <input type="text" value='{{ old("department_id") }}' class="form-control" name="department_id" id="department_id" placeholder="Enter department_id">
