...
<form method='post' action='{{asset("modelEmployees/".$item->id)}}'>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="notes">Department Number</label>
            <input type="text" value='{{old("department_id",$item->department_id) }}' class="form-control" name="department_id" id="department_id" placeholder="Enter Employee Number">
